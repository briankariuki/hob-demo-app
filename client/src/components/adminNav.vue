<template>
    ...
    >
      <v-list class="pa-1">
        ...
        <v-list-tile avatar>
          ...
          <v-list-tile-content v-if="$store.state.isAdminLoggedIn">
            <v-list-tile-title>
              <p class="body-1">{{$store.state.admin.email}}</p>
            </v-list-tile-title>
          </v-list-tile-content>
          <v-list-tile-action>
    ...
    <v-toolbar color="dark" dark>
      ...
      <v-toolbar-title>Hob | Admin</v-toolbar-title>
      ...
      <v-menu :nudge-bottom="50" light auto>
        ...
        <v-list v-if="$store.state.isAdminLoggedIn">
          <v-list-tile>
            <v-list-tile-title class="body-1">{{$store.state.admin.email}}</v-list-tile-title>
          </v-list-tile>
